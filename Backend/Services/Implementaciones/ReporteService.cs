...
namespace Backend.Services.Implementaciones
{
    public class ReporteService : IReporteService
    {
        ...
        private readonly UserManager<IdentityUser> _userManager; // ← CAMBIO AQUÍ

        public ReporteService(FinanceAppContext context, UserManager<IdentityUser> userManager) // ← Y AQUÍ
        {
            _context = context;
            _userManager = userManager;
        }

        public async Task<ReporteFinancieroDataDTO> GetReporteFinancieroDataAsync(string userId, ReporteFinancieroRequestDTO request)
        {
            ...
            // Para AporteMetaAhorro, asegúrate de que Ahorro.UsuarioId sea string y se relacione correctamente con IdentityUser.Id
            ...
            {
                // NOTA: IdentityUser no tiene propiedades Nombre y Apellidos por defecto
                // Si necesitas estos campos, considera usar ApplicationUser o ajustar esta lógica
            ...
            // 4. Transacciones Detalladas (Incluido por defecto)
        ...
        // El resto del código para GenerarPdfReporteFinanciero permanece igual...
        public byte[] GenerarPdfReporteFinanciero(ReporteFinancieroDataDTO data)
        {
            // ... código del PDF sin cambios
            ...
            var document = Document.Create(container =>
            {
                container.Page(page =>
                {
                    ...
                    // Aplicar estilo de texto predeterminado al contenido de la página
                    page.DefaultTextStyle(x => x.FontSize(10));

                    page.Header().Element(container =>
                    {
                        container.Text(data.TituloReporte ?? "Reporte Financiero Personal")
                            .FontSize(18)
                            .SemiBold()
                            .AlignCenter();
